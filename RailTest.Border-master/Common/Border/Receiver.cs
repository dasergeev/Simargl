...
namespace RailTest.Border
{
    ...
    internal sealed class Receiver
    {
        ...
        public Receiver()
        {
            ...
            //    {
            //        _Buffer[i] = (double*)Memory.Alloc(SizeInBlocks * BlockSize * sizeof(double));
            //    }
        ...
        /// <summary>
        /// Возвращает порт, по которому осуществляется подключение.
        /// </summary>
        ...
        //    Memory.Copy(data, source, ReadSize * sizeof(double));
        //    Memory.Zero(source, ReadSize * sizeof(double));
        //}
