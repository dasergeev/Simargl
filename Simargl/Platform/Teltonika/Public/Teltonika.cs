    ...
    IDisposable
{
    ...
    public Teltonika(IPAddress address, int nmeaPort, int geolocationPort, ICommandLine[] commandLines)
    {
        ...
        _IP = IsNotNull(address, nameof(address));
        ...
        _ComamandLineInterfaces.AddRange(IsNotNull(commandLines, nameof(commandLines)));

        //  Создание объекта низкого уровня модема.
        _ModemLowLevelInterface = new([.. _ComamandLineInterfaces]);

        //  Создание интерфейса управления процессами.
        _ProcessInterface = new([.. _ComamandLineInterfaces]);
