...
using Simargl.Zero.Ssh.Renci.SshNet;
    ...
    IDisposable
{
    ...
    public SshCommander(string host, int port, string username, string password)
    {
        ...
        _Host = IsNotNull(host, nameof(host));
        
        //  Инициализация порта удаленного узла.
        _Port = port;

        //  Инициализация имени пользователя.
        _Username = IsNotNull(username, nameof(username));

        //  Инициализация пароля пользователя.
        _Password = IsNotNull(password,nameof(password));
    ...
    public void UploadFile(string localPath, string remotePath)
    {
        ...
        {
            //  Проверка пути файла.
            IsNotNull(localPath, nameof(localPath));

            //  Проверка пути удаленного узла.
            IsNotNull(remotePath, nameof(remotePath));
