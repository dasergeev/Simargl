...
internal abstract class ECPoint
{
    ...
    protected static ECFieldElement[] GetInitialZCoords(ECCurve curve)
    {
        ...
        return coord switch
        {
            ECCurve.COORD_HOMOGENEOUS or ECCurve.COORD_JACOBIAN or ECCurve.COORD_LAMBDA_PROJECTIVE => new ECFieldElement[] { one },
            ECCurve.COORD_JACOBIAN_CHUDNOVSKY => new ECFieldElement[] { one, one, one },
            ECCurve.COORD_JACOBIAN_MODIFIED => new ECFieldElement[] { one, curve.A },
            _ => throw new ArgumentException("unknown coordinate system"),
        };
    }
