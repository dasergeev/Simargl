...
/// </summary>
internal class EcdsaDigitalSignature : DigitalSignature, IDisposable
{
    ...
    private sealed class SshDataSignature : SshData
    {
        ...
        public byte[] Signature
        {
            ...
            set
            {
                ...
                _signature_r = signed_r.ToBigInteger2().ToByteArray().ReverseBytes();

                var signed_s = new byte[_signature_size / 2];
                Buffer.BlockCopy(value, signed_r.Length, signed_s, 0, signed_s.Length);
                _signature_s = signed_s.ToBigInteger2().ToByteArray().ReverseBytes();
            }
        }
        ...
        {
            WriteBinaryString(_signature_r.ToBigInteger2().ToByteArray().ReverseBytes());
            WriteBinaryString(_signature_s.ToBigInteger2().ToByteArray().ReverseBytes());
        }
