...
//        var prefix = IsNotNull(line, nameof(line));
...
//        var identifier = IsNotNull(line, nameof(line));

//        //  Чтение строки.
//        line = reader.ReadLine();

//        //  Проверка чтения времени.
//        DateTime time = DateTime.Parse(IsNotNull(line, nameof(line)));

//        //  Чтение строки.
//        line = reader.ReadLine();

//        //  Проверка чтения длинны сообщения.
//        int length = int.Parse(IsNotNull(line, nameof(line)));
...
//        string message = IsNotNull(textBlock.ToString(), nameof(textBlock));
