...
/// <summary>
/// Предоставляет методы безопасного выполнения.
/// </summary>
public static class Safety
{
    /// <summary>
    /// Подавляет несистемные исключения.
    /// </summary>
    /// <param name="action">
    ...
    /// </exception>
    public static void DefySystem(Action action)
    {
    ...
    /// <summary>
    /// Подавляет некритические исключения.
    /// </summary>
    /// <param name="action">
    /// Действие, которое необходимо выполнить безопасно.
    /// </param>
    ...
    /// В параметре <paramref name="action"/> передана пустая ссылка.
    /// </exception>
    public static void DefyCritical(Action action)
    {
        //  Проверка ссылки на действие.
        IsNotNull(action, nameof(action));
    ...
    /// <summary>
    /// Асинхронно выполняет действие, подавляя несистемные исключения.
    /// </summary>
    /// <param name="action">
    /// Асинхронное действие, которое необходимо выполнить.
    /// </param>
    ...
    /// Операция отменена.
    /// </exception>
    public static async Task DefySystemAsync(AsyncAction action, CancellationToken cancellationToken)
    {
        //  Проверка ссылки на действие.
        IsNotNull(action, nameof(action));
    ...
    /// <summary>
    /// Асинхронно выполняет действие, подавляя некритические исключения.
    /// </summary>
    /// <param name="action">
    /// Асинхронное действие, которое необходимо выполнить.
    /// </param>
    ...
    /// Операция отменена.
    /// </exception>
    public static async Task DefyCriticalAsync(AsyncAction action, CancellationToken cancellationToken)
    {
        //  Проверка ссылки на действие.
        IsNotNull(action, nameof(action));
    ...
    //private static bool IsSystem(Exception exception)
    //{
