    ...
    IEnumerable<double>
{
    ...
    public Channel(Signal signal) :
        this(new SimpleChannelHeader(string.Empty, string.Empty, 0), signal)
    {
    ...
    public Channel(ChannelHeader header, double sampling, Vector<double> vector) :
        this(header, new Signal(sampling, vector.Items))
    {
    ...
    public Channel(string name, string unit, double sampling, double cutoff, int length) :
        this(new SimpleChannelHeader(name, unit, cutoff), sampling, new Vector<double>(length))
    {
    ...
    {
        get => new(_Signal.Items);
        set => _Signal.Items = value.Items;
    }
    ...
    public StorageFormat Format
    {
        ...
        set
        {
            ...
            if (_Header.Format != value)
            {
                ...
                _Header = ChannelHeaderConverter.Convert(_Header, (value));
            }
        }
    }
    ...
    {
        get => _Signal.Items[index];
        set => _Signal.Items[index] = value;
    }
    ...
    public IEnumerator<double> GetEnumerator()
    {
        ...
        return ((IEnumerable<double>)_Signal.Items).GetEnumerator();
    }
    ...
    {
        //  Возврат перечислителя сигнала.
        return _Signal.Items.GetEnumerator();
    }
}
