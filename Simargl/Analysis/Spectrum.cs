    ...
    ICloneable
{
    ...
    /// Шаг частоты.
    /// </param>
    private Spectrum([NoVerify] Complex[] amplitudes,
        [NoVerify] int signalLength, [NoVerify] double frequencyStep)
    {
        //  Установка полей.
    ...
    public Complex this[int index]
    {
        ...
        set
        {
            ...
            if (index == 0 || (index == Count - 1 && _IsEven))
            {
                ...
                //    throw ExceptionCreator.ArgumentOutOfRange(string.Empty);
                //}
                _Amplitudes[index] = value.Real;
            }
            else
            {
