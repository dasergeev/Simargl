hmLoadTopic({
hmKeywords:"",
hmTitle:"ksShellDefinition - методы",
hmDescription:"Подразделы: FaceArray - Получить указатель на интерфейс массива удаляемых граней",
hmPrevLink:"ksshelldefinition_thintype.html",
hmNextLink:"ksshelldefinition_facearray.html",
...
hmTitlePath:"API интерфейсов. Версия 5 > Документ - модель (Интерфейсы - ksDocument3D, IDocument3D )  > Компонент сборки (деталь или подсборка). Интерфейсы ksPart и IPart  > Объект модели (Интерфейсы ksEntity и IEntity)  > Интерфейсы ksEntity и iEntity - Интерфейс элемента модели (оси, плоскости, формообразующего элемента)  > Интерфейсы формообразующих операций  > Тонкостенная оболочка (Интерфейсы ksShellDefinition, IShellDefinition)  > ksShellDefinition - методы ",
hmHeader:"<h1 class=\"p_Heading1\"><span class=\"f_Heading1\">ksShellDefinition - методы <\/span><\/h1>\n\r",
hmBody:"<p class=\"p_Z_LOC_TOC_Title\" style=\"border-top: none; border-right: none; border-left: none;\"><span class=\"f_Z_LOC_TOC_Title\">Подразделы:<\/span><\/p>\n\r<p class=\"p_Z_LOC_TOC\"><span class=\"f_Z_LOC_TOC\"><a href=\"ksshelldefinition_facearray.html\" class=\"topiclink hmlinklistitem\">FaceArray - Получить указатель на интерфейс массива удаляемых граней <\/a><\/span><\/p>\n\r"
})
