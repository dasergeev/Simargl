hmLoadTopic({
hmKeywords:"",
hmTitle:"ksIsStudyVersion – Проверить, является ли версия учебной",
hmDescription:"Синтаксис: int LIB_FUNC ksIsStudyVersion(); Возвращаемое значение: 1 - Если запущена учебная версия Компас kStudy.exe. Подразделы: (отсутствуют)",
hmPrevLink:"ksisspdsversion.html",
hmNextLink:"kskompasvariant.html",
