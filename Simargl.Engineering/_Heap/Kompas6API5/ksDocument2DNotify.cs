...
//// Type: Kompas6API5.ksDocument2DNotify
...
//[ComImport]
//public interface ksDocument2DNotify
//{
//  [DispId(1)]
...
//  [DispId(4)]
//  [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  bool ChoiceMaterial([MarshalAs(UnmanagedType.BStr)] string material, double density);
...
//  [DispId(6)]
//  [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  bool LocalFragmentEdit([MarshalAs(UnmanagedType.IDispatch)] object newDoc, bool newFrw);
