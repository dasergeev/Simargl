...
//// Type: Kompas6API5.ksDocument2DNotify_EventProvider
...
//internal sealed class ksDocument2DNotify_EventProvider : ksDocument2DNotify_Event, IDisposable
//{
...
//  public virtual void add_BeginRebuild([In] ksDocument2DNotify_BeginRebuildEventHandler obj0)
//  {
//    bool lockTaken;
//    try
//    {
...
//        this.Init();
//      ksDocument2DNotify_SinkHelper pUnkSink = new ksDocument2DNotify_SinkHelper();
//      int pdwCookie = 0;
...
//  public virtual void remove_BeginRebuild([In] ksDocument2DNotify_BeginRebuildEventHandler obj0)
//  {
//    bool lockTaken;
//    try
//    {
...
//      do
//      {
//        ksDocument2DNotify_SinkHelper aEventSinkHelper = (ksDocument2DNotify_SinkHelper) this.m_aEventSinkHelpers[index];
...
//  public virtual void add_Rebuild([In] ksDocument2DNotify_RebuildEventHandler obj0)
//  {
//    bool lockTaken;
//    try
//    {
...
//  public virtual void remove_Rebuild([In] ksDocument2DNotify_RebuildEventHandler obj0)
//  {
//    bool lockTaken;
//    try
//    {
...
//    [In] ksDocument2DNotify_BeginChoiceMaterialEventHandler obj0)
//  {
//    bool lockTaken;
//    try
//    {
...
//  public virtual void add_ChoiceMaterial([In] ksDocument2DNotify_ChoiceMaterialEventHandler obj0)
//  {
//    bool lockTaken;
//    try
//    {
...
//  public virtual void remove_ChoiceMaterial([In] ksDocument2DNotify_ChoiceMaterialEventHandler obj0)
//  {
//    bool lockTaken;
//    try
//    {
...
//  public virtual void add_BeginInsertFragment(
//    [In] ksDocument2DNotify_BeginInsertFragmentEventHandler obj0)
//  {
//    bool lockTaken;
//    try
//    {
...
//      this.m_ConnectionPoint.Advise((object) pUnkSink, out pdwCookie);
//      pUnkSink.m_dwCookie = pdwCookie;
//      pUnkSink.m_BeginInsertFragmentDelegate = obj0;
//      this.m_aEventSinkHelpers.Add((object) pUnkSink);
//    }
//    finally
//    {
...
//  public virtual void remove_BeginInsertFragment(
//    [In] ksDocument2DNotify_BeginInsertFragmentEventHandler obj0)
//  {
//    bool lockTaken;
//    try
...
//      {
//        ksDocument2DNotify_SinkHelper aEventSinkHelper = (ksDocument2DNotify_SinkHelper) this.m_aEventSinkHelpers[index];
//        if (aEventSinkHelper.m_BeginInsertFragmentDelegate != null && ((aEventSinkHelper.m_BeginInsertFragmentDelegate.Equals((object) obj0) ? 1 : 0) & (int) byte.MaxValue) != 0)
//        {
//          this.m_aEventSinkHelpers.RemoveAt(index);
//          this.m_ConnectionPoint.Unadvise(aEventSinkHelper.m_dwCookie);
//          if (count <= 1)
...
//  public virtual void add_LocalFragmentEdit(
//    [In] ksDocument2DNotify_LocalFragmentEditEventHandler obj0)
//  {
//    bool lockTaken;
//    try
//    {
...
//      this.m_ConnectionPoint.Advise((object) pUnkSink, out pdwCookie);
//      pUnkSink.m_dwCookie = pdwCookie;
//      pUnkSink.m_LocalFragmentEditDelegate = obj0;
//      this.m_aEventSinkHelpers.Add((object) pUnkSink);
//    }
//    finally
//    {
...
//  public virtual void remove_LocalFragmentEdit(
//    [In] ksDocument2DNotify_LocalFragmentEditEventHandler obj0)
//  {
//    bool lockTaken;
//    try
...
//      {
//        ksDocument2DNotify_SinkHelper aEventSinkHelper = (ksDocument2DNotify_SinkHelper) this.m_aEventSinkHelpers[index];
//        if (aEventSinkHelper.m_LocalFragmentEditDelegate != null && ((aEventSinkHelper.m_LocalFragmentEditDelegate.Equals((object) obj0) ? 1 : 0) & (int) byte.MaxValue) != 0)
//        {
//          this.m_aEventSinkHelpers.RemoveAt(index);
//          this.m_ConnectionPoint.Unadvise(aEventSinkHelper.m_dwCookie);
//          if (count <= 1)
...
//    [In] ksDocument2DNotify_BeginChoicePropertyEventHandler obj0)
//  {
//    bool lockTaken;
//    try
//    {
...
//  public virtual void add_ChoiceProperty([In] ksDocument2DNotify_ChoicePropertyEventHandler obj0)
//  {
//    bool lockTaken;
//    try
//    {
...
//  public virtual void remove_ChoiceProperty([In] ksDocument2DNotify_ChoicePropertyEventHandler obj0)
//  {
//    bool lockTaken;
//    try
//    {
...
//    [In] ksDocument2DNotify_BeginDeletePropertyEventHandler obj0)
//  {
//    bool lockTaken;
//    try
//    {
...
//  public virtual void add_DeleteProperty([In] ksDocument2DNotify_DeletePropertyEventHandler obj0)
//  {
//    bool lockTaken;
//    try
//    {
...
//  public virtual void remove_DeleteProperty([In] ksDocument2DNotify_DeletePropertyEventHandler obj0)
//  {
//    bool lockTaken;
//    try
//    {
...
//  public ksDocument2DNotify_EventProvider([In] object obj0)
//  {
...
//        do
//        {
//          this.m_ConnectionPoint.Unadvise(((ksDocument2DNotify_SinkHelper) this.m_aEventSinkHelpers[index]).m_dwCookie);
//          ++index;
//        }
//        while (index < count);
//      }
