...
//// Type: Kompas6API5.ksBossExtrusionDefinition
...
//[ComImport]
//public interface ksBossExtrusionDefinition
//{
//  [DispId(1)]
...
//  [DispId(14)]
//  int chooseType { [DispId(14), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [DispId(14), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] set; }
...
//  [DispId(5)]
//  [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  bool SetSideParam(bool side1, short type = 0, double depth = 1.0, double draftValue = 0.0, bool draftOutward = false);
