...
//// Type: Kompas6API5.ksSpcObjectNotify
...
//[ComImport]
//public interface ksSpcObjectNotify
//{
//  [DispId(1)]
...
//  [DispId(7)]
//  [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  bool DocumentAdd(int objRef, [MarshalAs(UnmanagedType.BStr)] string docName);

//  [DispId(8)]
//  [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  bool DocumentRemove(int objRef, [MarshalAs(UnmanagedType.BStr)] string docName);
