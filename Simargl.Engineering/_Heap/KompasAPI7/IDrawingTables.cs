...
//// Type: KompasAPI7.IDrawingTables
...
//[ComImport]
//public interface IDrawingTables : IDrawingObjects
//{
//  [DispId(1000)]
...
//  DrawingTable get_DrawingTable([MarshalAs(UnmanagedType.Struct), In] object Index);
...
//  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  [return: MarshalAs(UnmanagedType.Interface)]
//  DrawingTable Load([MarshalAs(UnmanagedType.BStr), In] string FileName);
//}
