...
//[Guid("A81F2ABB-4F55-4C82-BDC8-78D10BAA8C15")]
//[ClassInterface(ClassInterfaceType.None)]
//[ComImport]
//public class ZoneClass : IZone, Zone, IKompasAPIObject, IModelObject
//{
//  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  internal extern ZoneClass();
...
//  [DispId(1)]
//  public virtual extern ksZoneTypeEnum ZoneType { [DispId(1), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [DispId(1), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }

//  [DispId(2)]
//  public virtual extern IKompasAPIObject Parameters { [DispId(2), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
...
//  public virtual extern object get_SelectObjects([In] ksRegionTypeEnum SelectType);

//  [DispId(5)]
//  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  [return: MarshalAs(UnmanagedType.Struct)]
//  public virtual extern object get_SelectParts([In] ksRegionTypeEnum SelectType);
