...
//// Type: KompasAPI7.ICloudPointsSurfaces
...
//[ComImport]
//public interface ICloudPointsSurfaces : IModelObjects
//{
//  [DispId(1000)]
...
//  CloudPointsSurface get_CloudPointsSurface([MarshalAs(UnmanagedType.Struct), In] object Index);

//  [DispId(2)]
//  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  [return: MarshalAs(UnmanagedType.Interface)]
//  CloudPointsSurface Add();

//  [DispId(3)]
//  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  [return: MarshalAs(UnmanagedType.Interface)]
//  CloudPointsSurface Load([MarshalAs(UnmanagedType.BStr), In] string FileName);
//}
