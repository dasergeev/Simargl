...
//[ComImport]
//public interface IBuildingAxes : IDrawingObjects
//{
//  [DispId(1000)]
...
//  IBuildingAxis get_BuildingAxis([MarshalAs(UnmanagedType.Struct), In] object Index);

//  [DispId(2)]
//  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  [return: MarshalAs(UnmanagedType.Interface)]
//  IBuildingAxis Add([In] DrawingObjectTypeEnum AxisType);
//}
