...
//// Type: KompasAPI7.IUnhistoredCurve3D
...
//[Guid("56F2843F-DE6A-43BC-ACCD-560B7FA7DD05")]
//[TypeLibType(TypeLibTypeFlags.FDual | TypeLibTypeFlags.FNonExtensible | TypeLibTypeFlags.FDispatchable)]
//[ComImport]
//public interface IUnhistoredCurve3D : IModelObject
//{
//  [DispId(1000)]
...
//  [DispId(1)]
//  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  bool Replace([MarshalAs(UnmanagedType.Interface), In] IModelObject Curve, [In] bool DeleteSource);

//  [DispId(2)]
//  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  bool Unwrap([MarshalAs(UnmanagedType.Struct), In] object Placement, [In] double X, [In] double Y, [In] double Z, [In] double Accuracy);
//}
