...
//// Type: KompasAPI7.ILineDimensions3D
...
//[ComImport]
//public interface ILineDimensions3D : IModelObjects
//{
//  [DispId(1000)]
...
//  IBaseLineDimension3D get_LineDimension3D([MarshalAs(UnmanagedType.Struct), In] object Index);

//  [DispId(2)]
//  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  [return: MarshalAs(UnmanagedType.Interface)]
//  IBaseLineDimension3D Add([In] ksObj3dTypeEnum DimType);
//}
