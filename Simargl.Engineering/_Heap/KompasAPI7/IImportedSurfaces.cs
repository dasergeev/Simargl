...
//// Type: KompasAPI7.IImportedSurfaces
...
//[ComImport]
//public interface IImportedSurfaces : IModelObjects
//{
//  [DispId(1000)]
...
//  ImportedSurface get_ImportedSurface([MarshalAs(UnmanagedType.Struct), In] object Index);
...
//  object Load([MarshalAs(UnmanagedType.BStr), In] string FileName, [In] bool SewSurfaces);
//}
