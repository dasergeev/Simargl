...
//[ComImport]
//public interface IRotateds : IModelObjects
//{
//  [DispId(1000)]
...
//  IRotated get_Rotated([MarshalAs(UnmanagedType.Struct), In] object Index);

//  [DispId(2)]
//  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  [return: MarshalAs(UnmanagedType.Interface)]
//  IRotated Add([In] ksObj3dTypeEnum RotatedType);
//}
