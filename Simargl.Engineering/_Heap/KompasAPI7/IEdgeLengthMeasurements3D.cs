...
//// Type: KompasAPI7.IEdgeLengthMeasurements3D
...
//[Guid("90749843-C25C-4E07-A432-F46201BEE90C")]
//[ComImport]
//public interface IEdgeLengthMeasurements3D : IModelObjects
//{
//  [DispId(1000)]
...
//  EdgeLengthMeasurement3D get_EdgeLengthMeasurement3D([MarshalAs(UnmanagedType.Struct), In] object Index);

//  [DispId(2)]
//  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  [return: MarshalAs(UnmanagedType.Interface)]
//  EdgeLengthMeasurement3D Add();
//}
