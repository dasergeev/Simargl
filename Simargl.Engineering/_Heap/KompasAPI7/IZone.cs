...
//[Guid("05C71C4B-F8BC-42E9-89D5-B9BC0145ED36")]
//[ComImport]
//public interface IZone : IModelObject
//{
//  [DispId(1000)]
...
//  [DispId(1)]
//  ksZoneTypeEnum ZoneType { [DispId(1), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [DispId(1), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }

//  [DispId(2)]
//  IKompasAPIObject Parameters { [DispId(2), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
...
//  object get_SelectObjects([In] ksRegionTypeEnum SelectType);

//  [DispId(5)]
//  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  [return: MarshalAs(UnmanagedType.Struct)]
//  object get_SelectParts([In] ksRegionTypeEnum SelectType);
//}
