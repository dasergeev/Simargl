...
//// Type: KompasAPI7.BodyRepositionClass
...
//[Guid("5924E1DF-1DBA-4076-88EE-55BFA2D4088D")]
//[ClassInterface(ClassInterfaceType.None)]
//[ComImport]
//public class BodyRepositionClass : IBodyReposition, BodyReposition, IKompasAPIObject, IModelObject
//{
//  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  internal extern BodyRepositionClass();
...
//  [DispId(801)]
//  public virtual extern IKompasAPIObject RepositionBody { [DispId(801), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: MarshalAs(UnmanagedType.Interface), In] set; [DispId(801), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }

//  [DispId(802)]
//  public virtual extern IModelObject RepositionCentre { [DispId(802), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; [DispId(802), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: MarshalAs(UnmanagedType.Interface), In] set; }

//  [DispId(803)]
//  public virtual extern bool CopyBoby { [DispId(803), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [DispId(803), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }

//  [DispId(804)]
//  public virtual extern LocalCoordinateSystem Position { [DispId(804), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Interface)] get; }
