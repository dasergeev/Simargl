...
//// Type: KompasAPI7.IBreakRadialDimensions
...
//[ComImport]
//public interface IBreakRadialDimensions : IDrawingObjects
//{
//  [DispId(1000)]
...
//  BreakRadialDimension get_BreakRadialDimension([MarshalAs(UnmanagedType.Struct), In] object Index);

//  [DispId(2)]
//  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  [return: MarshalAs(UnmanagedType.Interface)]
//  BreakRadialDimension Add();
//}
