...
//// Type: KompasAPI7.IBilletsObsoletes
...
//[Guid("140DE7B8-8291-4220-B7FB-9F3C4FDFB649")]
//[ComImport]
//public interface IBilletsObsoletes : IModelObjects
//{
//  [DispId(1000)]
...
//  BilletObsolete get_BilletObsolete([MarshalAs(UnmanagedType.Struct), In] object Index);

//  [DispId(2)]
//  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  [return: MarshalAs(UnmanagedType.Interface)]
//  BilletObsolete Add([MarshalAs(UnmanagedType.BStr), In] string FileName, [In] bool Mirror);
//}
