...
//[ComImport]
//public interface ILeaders : IDrawingObjects
//{
//  [DispId(1000)]
...
//  BaseLeader get_Leader([MarshalAs(UnmanagedType.Struct), In] object Index);

//  [DispId(2)]
//  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  [return: MarshalAs(UnmanagedType.Interface)]
//  BaseLeader Add([In] DrawingObjectTypeEnum DimType);
//}
