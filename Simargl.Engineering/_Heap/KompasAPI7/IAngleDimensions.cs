...
//// Type: KompasAPI7.IAngleDimensions
...
//[ComImport]
//public interface IAngleDimensions : IDrawingObjects
//{
//  [DispId(1000)]
...
//  IAngleDimension get_AngleDimension([MarshalAs(UnmanagedType.Struct), In] object Index);

//  [DispId(2)]
//  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  [return: MarshalAs(UnmanagedType.Interface)]
//  IAngleDimension Add([In] DrawingObjectTypeEnum DimType);
//}
