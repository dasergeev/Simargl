...
//[ComImport]
//public interface IBaseLeader : IDrawingObject
//{
//  [DispId(1000)]
...
//  [DispId(4001)]
//  ksArrowEnum ArrowType { [DispId(4001), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [DispId(4001), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }

//  [DispId(4002)]
//  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  bool GetBranchTextPosition(out double X, out double Y);

//  [DispId(4003)]
//  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  bool SetBranchTextPosition([In] double X, [In] double Y);
//}
