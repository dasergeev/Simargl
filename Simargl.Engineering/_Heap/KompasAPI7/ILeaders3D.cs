...
//[ComImport]
//public interface ILeaders3D : IModelObjects
//{
//  [DispId(1000)]
...
//  BaseLeader3D get_Leader3D([MarshalAs(UnmanagedType.Struct), In] object Index);

//  [DispId(2)]
//  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  [return: MarshalAs(UnmanagedType.Interface)]
//  BaseLeader3D Add([In] ksObj3dTypeEnum DimType);
//}
