...
//// Type: KompasAPI7.IFeaturePatterns
...
//[ComImport]
//public interface IFeaturePatterns : IModelObjects
//{
//  [DispId(1000)]
...
//  IFeaturePattern get_FeaturePattern([MarshalAs(UnmanagedType.Struct), In] object Index);

//  [DispId(2)]
//  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  [return: MarshalAs(UnmanagedType.Interface)]
//  IFeaturePattern Add([In] ksObj3dTypeEnum Type);
//}
