...
//// Type: KompasAPI7.PointsArrFromFileClass
...
//[Guid("02155ADC-2F79-497F-9E33-9E3496050C71")]
//[ClassInterface(ClassInterfaceType.None)]
//[ComImport]
//public class PointsArrFromFileClass : 
//  IPointsArrFromFile,
//  PointsArrFromFile,
//  IKompasAPIObject,
//  IModelObject
...
//  internal extern PointsArrFromFileClass();
...
//  [DispId(1)]
//  public virtual extern ksPoint3DTypeEnum PointsType { [DispId(1), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; [DispId(1), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }

//  [DispId(2)]
//  public virtual extern string FileName { [DispId(2), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: MarshalAs(UnmanagedType.BStr), In] set; [DispId(2), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.BStr)] get; }

//  [DispId(3)]
//  public virtual extern ksAnnotationSymbolEnum Symbol { [DispId(3), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; [DispId(3), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
