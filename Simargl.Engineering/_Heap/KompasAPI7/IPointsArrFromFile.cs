...
//// Type: KompasAPI7.IPointsArrFromFile
...
//[Guid("782932B2-8969-41E1-819C-2458EA6DC8C0")]
//[ComImport]
//public interface IPointsArrFromFile : IModelObject
//{
//  [DispId(1000)]
...
//  [DispId(2)]
//  string FileName { [DispId(2), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: MarshalAs(UnmanagedType.BStr), In] set; [DispId(2), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.BStr)] get; }

//  [DispId(3)]
//  ksAnnotationSymbolEnum Symbol { [DispId(3), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; [DispId(3), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
