...
//// Type: KompasAPI7.IAreaMeasurement3D
...
//[Guid("02D1F030-8709-4602-8BAE-E47CE1C9C13D")]
//[ComImport]
//public interface IAreaMeasurement3D : IModelObject
//{
//  [DispId(1000)]
...
//  [DispId(2)]
//  object Areas { [DispId(2), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Struct)] get; }

//  [DispId(3)]
//  double Sum { [DispId(3), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
//}
