...
//// Type: KompasAPI7.LocalCoordinateSystem2DClass
...
//[Guid("BCB037A2-D246-44AF-92EF-FDC54624FFA2")]
//[ClassInterface(ClassInterfaceType.None)]
//[ComImport]
//public class LocalCoordinateSystem2DClass : 
//  ILocalCoordinateSystem2D,
//  LocalCoordinateSystem2D,
//  IKompasAPIObject
//{
//  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  internal extern LocalCoordinateSystem2DClass();
...
//  [DispId(5)]
//  public virtual extern string AxisXLabel { [DispId(5), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: MarshalAs(UnmanagedType.BStr), In] set; [DispId(5), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.BStr)] get; }

//  [DispId(6)]
//  public virtual extern string AxisYLabel { [DispId(6), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: MarshalAs(UnmanagedType.BStr), In] set; [DispId(6), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.BStr)] get; }
