...
//[Guid("FEC86293-7AB2-4BBB-8BAF-53EC5D033AFE")]
//[ComImport]
//public interface IModelTables : IModelObjects
//{
//  [DispId(1000)]
...
//  ModelTable get_ModelTable([MarshalAs(UnmanagedType.Struct), In] object Index);
...
//  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  [return: MarshalAs(UnmanagedType.Interface)]
//  ModelTable Load([MarshalAs(UnmanagedType.BStr), In] string FileName);
//}
