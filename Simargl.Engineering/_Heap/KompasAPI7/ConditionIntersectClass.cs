...
//// Type: KompasAPI7.ConditionIntersectClass
...
//[Guid("F7458066-14B5-4945-ACCC-1199F98AAFDA")]
//[ClassInterface(ClassInterfaceType.None)]
//[ComImport]
//public class ConditionIntersectClass : 
//  IConditionIntersect,
//  ConditionIntersect,
//  IKompasAPIObject,
//  IDrawingObject
...
//  internal extern ConditionIntersectClass();
...
//  [DispId(1)]
//  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  public virtual extern bool GetIntersectPoint(out double X, out double Y);

//  [DispId(2)]
//  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  public virtual extern bool GetCurvePoint([In] bool FirstCurve, out double X, out double Y);

//  [DispId(3)]
//  public virtual extern bool RemoteLine1Visible { [DispId(3), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; [DispId(3), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }

//  [DispId(4)]
//  public virtual extern bool RemoteLine2Visible { [DispId(4), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; [DispId(4), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }

//  [DispId(5)]
//  public virtual extern bool Gap { [DispId(5), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [DispId(5), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }

//  [DispId(6)]
//  public virtual extern double GapValue { [DispId(6), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; [DispId(6), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; }

//  [DispId(7)]
//  public virtual extern bool PointVisible { [DispId(7), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; [DispId(7), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }

//  [DispId(8)]
//  public virtual extern ksAnnotationSymbolEnum PointStyle { [DispId(8), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; [DispId(8), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }

//  [DispId(9)]
//  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  public virtual extern bool InitByObjects(
//    [MarshalAs(UnmanagedType.Interface), In] IKompasAPIObject Curve1,
//    [MarshalAs(UnmanagedType.Interface), In] IKompasAPIObject Curve2,
//    [In, Out] ref double X1,
//    [In, Out] ref double Y1,
//    [In, Out] ref double X2,
//    [In, Out] ref double Y2,
//    [In] bool RemoteLine1Visible,
//    [In] bool RemoteLine2Visible);

//  [DispId(10)]
//  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  [return: MarshalAs(UnmanagedType.Interface)]
//  public virtual extern IDrawingObject get_AssociationObject([In] bool First);
