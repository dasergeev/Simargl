...
//// Type: KompasAPI7.IPropertyBmpList
...
//[ComImport]
//public interface IPropertyBmpList : IPropertyControl
//{
//  [DispId(1000)]
...
//  void Add([MarshalAs(UnmanagedType.BStr), In] string NewStr, [MarshalAs(UnmanagedType.Struct), In] object NewBmp);

//  [DispId(102)]
//  int Count { [DispId(102), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }
...
//  [DispId(104)]
//  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  int Find([MarshalAs(UnmanagedType.BStr), In] string Val);

//  [DispId(105)]
//  int CurrentIndex { [DispId(105), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: In] set; [DispId(105), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] get; }

//  [DispId(106)]
//  object ResModule { [DispId(106), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [param: MarshalAs(UnmanagedType.Struct), In] set; [DispId(106), MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)] [return: MarshalAs(UnmanagedType.Struct)] get; }

//  [DispId(107)]
//  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  void set_IconFont([In] int Index, [MarshalAs(UnmanagedType.BStr), In] string PVal);

//  [DispId(107)]
//  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  [return: MarshalAs(UnmanagedType.BStr)]
//  string get_IconFont([In] int Index);
//}
