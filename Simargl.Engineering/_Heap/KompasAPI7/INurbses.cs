...
//[ComImport]
//public interface INurbses : IDrawingObjects
//{
//  [DispId(1000)]
...
//  _Nurbs get_Nurbs([MarshalAs(UnmanagedType.Struct), In] object Index);
...
//  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  [return: MarshalAs(UnmanagedType.Interface)]
//  _Nurbs Convert([MarshalAs(UnmanagedType.Interface), In] IDrawingObject Curve);
