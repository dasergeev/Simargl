...
//[ComImport]
//public interface IMarks : IDrawingObjects
//{
//  [DispId(1000)]
...
//  IMark get_Mark([MarshalAs(UnmanagedType.Struct), In] object Index);

//  [DispId(2)]
//  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  [return: MarshalAs(UnmanagedType.Interface)]
//  IMark Add([In] DrawingObjectTypeEnum MarkType);
//}
