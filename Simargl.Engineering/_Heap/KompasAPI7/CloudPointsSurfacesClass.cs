...
//// Type: KompasAPI7.CloudPointsSurfacesClass
...
//[Guid("9860A4F8-58DC-4285-B1B0-5EB539D2A6CA")]
//[ComImport]
//public class CloudPointsSurfacesClass : 
...
//  internal extern CloudPointsSurfacesClass();
...
//  public virtual extern CloudPointsSurface get_CloudPointsSurface([MarshalAs(UnmanagedType.Struct), In] object Index);

//  [DispId(2)]
//  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  [return: MarshalAs(UnmanagedType.Interface)]
//  public virtual extern CloudPointsSurface Add();

//  [DispId(3)]
//  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  [return: MarshalAs(UnmanagedType.Interface)]
//  public virtual extern CloudPointsSurface Load([MarshalAs(UnmanagedType.BStr), In] string FileName);
