...
//[ComImport]
//public interface IBase3D : IModelObject
//{
//  [DispId(1000)]
...
//  [DispId(10)]
//  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  bool SetBranchBeginPoint([In] double X, [In] double Y, [In] double Z, [MarshalAs(UnmanagedType.Interface), In] IModelObject Object);

//  [DispId(11)]
//  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  bool GetBranchEndPoint(out double X, out double Y, out double Z);

//  [DispId(12)]
//  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  bool SetBranchEndPoint([In] double X, [In] double Y, [In] double Z);
//}
