...
//// Type: KompasAPI7.IInsertionObjects
...
//[ComImport]
//public interface IInsertionObjects : IDrawingObjects
//{
//  [DispId(1000)]
...
//  IInsertionObject get_InsertionObject([MarshalAs(UnmanagedType.Struct), In] object Index);

//  [DispId(2)]
//  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  [return: MarshalAs(UnmanagedType.Interface)]
//  IInsertionObject Add([MarshalAs(UnmanagedType.Interface), In] InsertionDefinition Definition);
//}
