...
//// Type: KompasAPI7.ExtrusionsClass
...
//[Guid("2B4C99E4-FB5D-4D7D-A44D-5B898E1F5E9E")]
//[ComImport]
//public class ExtrusionsClass : 
//  IExtrusions,
//  Extrusions,
//  IKompasAPIObject,
//  IKompasCollection,
...
//  internal extern ExtrusionsClass();
...
//  public virtual extern IExtrusion get_Extrusion([MarshalAs(UnmanagedType.Struct), In] object Index);

//  [DispId(2)]
//  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  [return: MarshalAs(UnmanagedType.Interface)]
//  public virtual extern IExtrusion Add([In] ksObj3dTypeEnum ExtrusionType);
