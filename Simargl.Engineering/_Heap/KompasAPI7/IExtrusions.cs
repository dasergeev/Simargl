...
//[ComImport]
//public interface IExtrusions : IModelObjects
//{
//  [DispId(1000)]
...
//  IExtrusion get_Extrusion([MarshalAs(UnmanagedType.Struct), In] object Index);

//  [DispId(2)]
//  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  [return: MarshalAs(UnmanagedType.Interface)]
//  IExtrusion Add([In] ksObj3dTypeEnum ExtrusionType);
//}
