...
//// Type: KompasAPI7.Tolerances3DClass
...
//[Guid("EE1CF4A7-CB7E-42C2-854D-32EB10E28C78")]
//[ComImport]
//public class Tolerances3DClass : 
//  ITolerances3D,
//  Tolerances3D,
//  IKompasAPIObject,
//  IKompasCollection,
...
//  internal extern Tolerances3DClass();
...
//  public virtual extern Tolerance3D get_Tolerance3D([MarshalAs(UnmanagedType.Struct), In] object Index);

//  [DispId(2)]
//  [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  [return: MarshalAs(UnmanagedType.Interface)]
//  public virtual extern Tolerance3D Add();
