...
//// Type: Kompas6API3D5COM.IPlaneTangentToSurfaceDefinition
...
//[ComImport]
//public interface IPlaneTangentToSurfaceDefinition
//{
...
//  [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  int SetFace([MarshalAs(UnmanagedType.Interface)] IEntity val);
...
//  [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  int SetPlane([MarshalAs(UnmanagedType.Interface)] IEntity val);

//  [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  short GetChoosePlane();

//  [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  int SetChoosePlane(short Choose);
