...
//// Type: Kompas6API3D5COM.IPlane3PointsDefinition
...
//[ComImport]
//public interface IPlane3PointsDefinition
//{
//  [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  [return: MarshalAs(UnmanagedType.Interface)]
//  IEntity GetPoint(int number);

//  [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  int SetPoint(int number, [MarshalAs(UnmanagedType.Interface)] IEntity val);
