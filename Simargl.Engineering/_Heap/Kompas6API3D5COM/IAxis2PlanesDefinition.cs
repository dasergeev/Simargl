...
//// Type: Kompas6API3D5COM.IAxis2PlanesDefinition
...
//[ComImport]
//public interface IAxis2PlanesDefinition
//{
//  [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  [return: MarshalAs(UnmanagedType.Interface)]
//  IEntity GetPlane(int number);

//  [MethodImpl(MethodImplOptions.PreserveSig | MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
//  int SetPlane(int number, [MarshalAs(UnmanagedType.Interface)] IEntity plane);
