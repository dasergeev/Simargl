    ...
    INotifyPropertyChanged
{
    ...
    public string SensorType
    {
        ...
        private set
        {
            ...
            value = IsNotNull(value, nameof(SensorType));
    ...
    public string FirmwareVersion
    {
        ...
        {
            //  Проверка ссылки на новое значение.
            value = IsNotNull(value, nameof(FirmwareVersion));
    ...
    public string FirmwareDate
    {
        ...
        {
            //  Проверка ссылки на новое значение.
            value = IsNotNull(value, nameof(FirmwareDate));
    ...
    public long SerialNumber
    {
        ...
        private set
        {
            ...
            IsNotNegative(value, nameof(SerialNumber));
            IsNotLarger(value, uint.MaxValue, nameof(SerialNumber));
    ...
    public int UdpPort
    {
        ...
        {
            //  Проверка значения.
            IsNotLess(value, IPEndPoint.MinPort, nameof(UdpPort));
            IsNotLarger(value, IPEndPoint.MaxPort, nameof(UdpPort));
    ...
    public int TcpPort
    {
        ...
        {
            //  Проверка значения.
            IsNotLess(value, IPEndPoint.MinPort, nameof(TcpPort));
            IsNotLarger(value, IPEndPoint.MaxPort, nameof(TcpPort));
    ...
    public int MeasuringRange
    {
        ...
        set
        {
            ...
            {
                throw ExceptionsCreator.ArgumentOutOfRange(nameof(MeasuringRange));
            }
    ...
    public int HighPassFilter
    {
        ...
        {
            //  Проверка значения.
            IsNotNegative(value, nameof(HighPassFilter));
            IsNotLarger(value, 6, nameof(HighPassFilter));
    ...
    public double XOffset
    {
        ...
        {
            //  Проверка значения.
            IsNotNaN(value, nameof(XOffset));
            IsNotInfinity(value, nameof(XOffset));
    ...
    public double YOffset
    {
        ...
        {
            //  Проверка значения.
            IsNotNaN(value, nameof(YOffset));
            IsNotInfinity(value, nameof(YOffset));
    ...
    public double ZOffset
    {
        ...
        {
            //  Проверка значения.
            IsNotNaN(value, nameof(ZOffset));
            IsNotInfinity(value, nameof(ZOffset));
    ...
    public IPAddress Address
    {
        ...
        set
        {
            ...
            value = IsNotNull(value, nameof(Address));

            //  Проверка схемы адресации.
            if (value.AddressFamily != AddressFamily.InterNetwork)
            {
                //  Не является IPv4-адресом.
                throw ExceptionsCreator.ArgumentOutOfRange(nameof(Address));
            }
    ...
    public IPAddress SubnetMask
    {
        ...
        {
            //  Проверка ссылки на значения.
            value = IsNotNull(value, nameof(SubnetMask));

            //  Проверка схемы адресации.
            if (value.AddressFamily != AddressFamily.InterNetwork)
            {
                //  Не является IPv4-адресом.
                throw ExceptionsCreator.ArgumentOutOfRange(nameof(SubnetMask));
            }
    ...
    public IPAddress Gateway
    {
        ...
        {
            //  Проверка ссылки на значения.
            value = IsNotNull(value, nameof(Gateway));

            //  Проверка схемы адресации.
            if (value.AddressFamily != AddressFamily.InterNetwork)
            {
                //  Не является IPv4-адресом.
                throw ExceptionsCreator.ArgumentOutOfRange(nameof(Gateway));
            }
    ...
    public IPAddress ServerAddress
    {
        ...
        {
            //  Проверка ссылки на значения.
            value = IsNotNull(value, nameof(ServerAddress));

            //  Проверка схемы адресации.
            if (value.AddressFamily != AddressFamily.InterNetwork)
            {
                //  Не является IPv4-адресом.
                throw ExceptionsCreator.ArgumentOutOfRange(nameof(ServerAddress));
            }
    ...
    public double MaxTemperature
    {
        ...
        {
            //  Проверка значения.
            IsNotNaN(value, nameof(MaxTemperature));
            IsNotInfinity(value, nameof(MaxTemperature));
    ...
    public double MinTemperature
    {
        ...
        {
            //  Проверка значения.
            IsNotNaN(value, nameof(MinTemperature));
            IsNotInfinity(value, nameof(MinTemperature));
    ...
    public double MaxVoltage
    {
        ...
        {
            //  Проверка значения.
            IsNotNaN(value, nameof(MaxVoltage));
            IsNotInfinity(value, nameof(MaxVoltage));
    ...
    public double MinVoltage
    {
        ...
        {
            //  Проверка значения.
            IsNotNaN(value, nameof(MinVoltage));
            IsNotInfinity(value, nameof(MinVoltage));
    ...
    public double DiagnosticValue
    {
        ...
        {
            //  Проверка значения.
            IsNotNaN(value, nameof(DiagnosticValue));
            IsNotInfinity(value, nameof(DiagnosticValue));
    ...
    public long ErrorCodes
    {
        ...
        {
            //  Проверка значения.
            IsNotNegative(value, nameof(ErrorCodes));
            IsNotLarger(value, uint.MaxValue, nameof(ErrorCodes));
    ...
    public int State
    {
        ...
        {
            //  Проверка значения.
            IsNotNegative(value, nameof(State));
            IsNotLarger(value, ushort.MaxValue, nameof(State));
    ...
    public AdxlModbus(IPAddress address, int port)
    {
        ...
        IsNotLess(port, ushort.MinValue, nameof(port));

        //  Проверка максимального значения порта.
        IsNotLarger(port, ushort.MaxValue, nameof(port));
    ...
    public string GetValue(string property)
    {
        ...
        IsNotNull(property, nameof(property));
        ...
        try
        {
            ...
            //  Проверка ссылки.
            info = IsNotNull(info, nameof(property));

            //  Получение значения.
            var value = info.GetValue(this);

            //  Проверка ссылки.
            value = IsNotNull(value, nameof(property)).ToString();

            //  Проверка результата.
            string result = IsNotNull(value!.ToString(), nameof(property));
