        ...
        lock (_SyncRoot)
        {
            ...
            foreach (var one in _Interfaces)
            {
                ...
                try
                {
                    ...
                    var imei = IsNotNull(reader.ReadLine(), nameof(reader));
                    var iccid = IsNotNull(reader.ReadLine(), nameof(reader));
                    var imsi = IsNotNull(reader.ReadLine(), nameof(reader));
                    var signal = int.Parse(IsNotNull(reader.ReadLine(), nameof(reader)));
