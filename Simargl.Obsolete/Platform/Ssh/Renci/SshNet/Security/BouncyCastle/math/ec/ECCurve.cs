...
using Simargl.Zero.Ssh.Renci.SshNet.Security.Org.BouncyCastle.Math.EC.Abc;
using Simargl.Zero.Ssh.Renci.SshNet.Security.Org.BouncyCastle.Math.EC.Endo;
using Simargl.Zero.Ssh.Renci.SshNet.Security.Org.BouncyCastle.Math.EC.Multiplier;
using Simargl.Zero.Ssh.Renci.SshNet.Security.Org.BouncyCastle.Math.Field;
using Simargl.Zero.Ssh.Renci.SshNet.Security.Org.BouncyCastle.Utilities;

namespace Simargl.Zero.Ssh.Renci.SshNet.Security.Org.BouncyCastle.Math.EC;
    ...
    : AbstractFpCurve
{
    ...
    public override bool SupportsCoordinateSystem(int coord)
    {
        return coord switch
        {
            COORD_AFFINE or COORD_HOMOGENEOUS or COORD_JACOBIAN or COORD_JACOBIAN_MODIFIED => true,
            _ => false,
        };
    }
    ...
    : AbstractF2mCurve
{
    ...
    public override bool SupportsCoordinateSystem(int coord)
    {
        return coord switch
        {
            COORD_AFFINE or COORD_HOMOGENEOUS or COORD_LAMBDA_PROJECTIVE => true,
            _ => false,
        };
    }
