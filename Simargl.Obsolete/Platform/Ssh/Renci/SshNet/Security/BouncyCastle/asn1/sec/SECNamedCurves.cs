...
using Simargl.Zero.Ssh.Renci.SshNet.Security.Org.BouncyCastle.Asn1.X9;
...
using Simargl.Zero.Ssh.Renci.SshNet.Security.Org.BouncyCastle.Utilities.Encoders;

namespace Simargl.Zero.Ssh.Renci.SshNet.Security.Org.BouncyCastle.Asn1.Sec;
...
internal sealed class SecNamedCurves
{
        ...
        string name)
    {
        return name switch
        {
            "P-256" or "secp256r1" => Secp256r1Holder.Instance.Parameters,
            "P-384" or "secp384r1" => Secp384r1Holder.Instance.Parameters,
            "P-521" or "secp521r1" => Secp521r1Holder.Instance.Parameters,
            _ => null,
        };
    }
