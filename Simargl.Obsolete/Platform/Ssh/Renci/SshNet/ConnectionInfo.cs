...
using Simargl.Zero.Ssh.Renci.SshNet.Compression;
using Simargl.Zero.Ssh.Renci.SshNet.Messages.Authentication;
using Simargl.Zero.Ssh.Renci.SshNet.Messages.Connection;
...
/// client instances.
/// </remarks>
internal class ConnectionInfo : IConnectionInfoInternal
{
