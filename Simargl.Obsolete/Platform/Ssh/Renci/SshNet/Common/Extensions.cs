...
internal static partial class Extensions
{
    internal static byte[] ToArray(this ServiceName serviceName)
    {
        return serviceName switch
        {
            ...
            _ => throw new NotSupportedException(string.Format("Service name '{0}' is not supported.", serviceName)),
        };
    }
    ...
    internal static ServiceName ToServiceName(this byte[] data)
    {
        ...
        return sshServiceName switch
        {
            "ssh-userauth" => ServiceName.UserAuthentication,
            "ssh-connection" => ServiceName.Connection,
            _ => throw new NotSupportedException(string.Format("Service name '{0}' is not supported.", sshServiceName)),
        };
    }
    ...
    internal static BigInteger ToBigInteger(this byte[] data)
    {
        ...
        return new BigInteger(reversed.ReverseBytes());
    }
    ...
    /// </returns>
    internal static T[] ReverseBytes<T>(this T[] array)
    {
        Array.Reverse(array);
        return array;
    }
