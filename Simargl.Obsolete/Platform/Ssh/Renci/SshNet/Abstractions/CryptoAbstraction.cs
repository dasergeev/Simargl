...
namespace Simargl.Zero.Ssh.Renci.SshNet.Abstractions;
...
#else
    public static global::Simargl.Zero.Ssh.SshNet.Security.Cryptography.RIPEMD160 CreateRIPEMD160()
    {
        return new global::Simargl.Zero.Ssh.SshNet.Security.Cryptography.RIPEMD160();
    }
...
#else
    public static global::Simargl.Zero.Ssh.SshNet.Security.Cryptography.HMACRIPEMD160 CreateHMACRIPEMD160(byte[] key)
    {
        return new global::Simargl.Zero.Ssh.SshNet.Security.Cryptography.HMACRIPEMD160(key);
    }
