...
namespace Simargl.Recording.Stm32;
    ...
    IComparable
{
    ...
    /// </remarks>
    public readonly long Ticks => Value * TimeSpan.TicksPerMillisecond;
    ...
    /// </returns>
    public readonly DateTime ToUnixTime()
    {
    ...
    /// </returns>
    public readonly bool Equals(Stm32Synchromarker other)
    {
        //  Сравнение.
    ...
    /// </para>
    /// </returns>
    public readonly int CompareTo(Stm32Synchromarker other)
    {
        //  Сравнение.
    ...
    readonly int IComparable.CompareTo(object? obj)
    {
        ...
        //  Сравнение значений.
        return CompareCore(this, (Stm32Synchromarker)obj!);
    }
