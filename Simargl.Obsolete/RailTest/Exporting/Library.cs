...
namespace RailTest.Exporting
{
    ...
    public partial class Library
    {
        ...
        [SuppressUnmanagedCodeSecurity]
        private static partial int DisableThreadLibraryCalls(IntPtr hLibModule);

        [LibraryImport("Kernel32.dll")]
        [SuppressUnmanagedCodeSecurity]
        private static partial int FreeLibrary(IntPtr hLibModule);

        [LibraryImport("Kernel32.dll")]
        [SuppressUnmanagedCodeSecurity]
        private static partial void FreeLibraryAndExitThread(IntPtr hLibModule, uint dwExitCode);

        [LibraryImport("Kernel32.dll", StringMarshalling = StringMarshalling.Utf16)]
        [SuppressUnmanagedCodeSecurity]
        private static partial uint GetDllDirectoryW(uint nBufferLength, string lpBuffer);

        [LibraryImport("Kernel32.dll", StringMarshalling = StringMarshalling.Utf16)]
        [SuppressUnmanagedCodeSecurity]
        private static partial uint GetModuleFileNameW(IntPtr hModule, string lpFilename, uint nSize);
        ...
        [LibraryImport("Kernel32.dll", StringMarshalling = StringMarshalling.Utf16)]
        [SuppressUnmanagedCodeSecurity]
        private static unsafe partial int GetModuleHandleExW(uint dwFlags, string lpModuleName, IntPtr* phModule);
        ...
        [LibraryImport("Kernel32.dll", StringMarshalling = StringMarshalling.Utf16)]
        [SuppressUnmanagedCodeSecurity]
        private static partial IntPtr LoadPackagedLibrary(string lpwLibFileName, uint Reserved);

        [LibraryImport("Kernel32.dll")]
        [SuppressUnmanagedCodeSecurity]
        private static partial int RemoveDllDirectory(IntPtr Cookie);
        ...
        [LibraryImport("Kernel32.dll", StringMarshalling = StringMarshalling.Utf16)]
        [SuppressUnmanagedCodeSecurity]
        private static partial int SetDllDirectoryW(string lpPathName);
    }
}
