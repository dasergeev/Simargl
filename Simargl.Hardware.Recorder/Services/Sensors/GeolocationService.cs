...
public sealed class GeolocationService(
    ILogger<GeolocationService> logger, Heart heart) :
    Service<GeolocationService>(logger, heart)
{
    /// <summary>
    ...
    {
        //  Работа с данными.
        await Heart.Measurer.GeolocationInvokeAsync(Logger, cancellationToken).ConfigureAwait(false);
    }
}
