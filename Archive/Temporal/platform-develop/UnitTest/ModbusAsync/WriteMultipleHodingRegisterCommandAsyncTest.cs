...
namespace UnitTest
{
    ...
    /// </summary>
    [TestClass]
    public class WriteMultipleHodingRegisterCommandAsyncTest
    {
        /// <summary>
        /// Представляет фунцкцию тестирования <see cref="WriteMultipleHodingRegisterCommand"/>.
        /// </summary>
        [TestMethod]
        public async Task TestWriteMultipleHodingRegisterCommandAsync()
        {
            ...
            for (int i = 0; i < iterationCount; i++)
            {
                ...
                ushort countRegister = ((ushort)(random.Next()% WriteMultipleHodingRegisterCommand.MaximumRegisterCount));
                ...
                var sourcePackage = new WriteMultipleHodingRegisterCommand(transactionIdentifier,modbusAddress, startAddress, registers);
                ...
                var resultPackage = new WriteMultipleHodingRegisterCommand();
                ...
                //  Проверка значения функционального кода.
                Assert.AreEqual(WriteMultipleHodingRegisterCommand.CodeCommand, resultPackage.FunctionalCode);
