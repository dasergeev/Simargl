...
using Apeiron.Platform.Microservices;
    ...
    where TMicroservice : ServerMicroservice<TMicroservice>
{
    ...
    /// </summary>
    private volatile int _NextStepDelay = 1000;
    ...
    protected override sealed async Task ExecuteAsync(CancellationToken cancellationToken)
    {
        ...
        while (!cancellationToken.IsCancellationRequested)
        {
            ...
            await Invoker.SafeNotCriticalAsync(UpdateNextStepDelayAsync, cancellationToken).ConfigureAwait(false);
