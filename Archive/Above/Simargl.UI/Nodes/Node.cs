    ...
    INotifyPropertyChanged
{
    ...
    /// </summary>
    public abstract ControlSource ItemSource { get; }

    /// <summary>
    /// Возвращает источник элемента управления, отображающего данные узла.
    /// </summary>
    public virtual ControlSource ViewSource { get; } = new ControlSource<NodeView>();

    /// <summary>
    /// Возвращает источник элемента управления, отображающего вкладку панели управления.
    /// </summary>
    public virtual ControlSource TabSource { get; } = new ControlSource<NodeTab>();
}
