    ...
    public partial class MainWindow : Window
    {
        ...
        private void MtpHook(object? obj, DataEventArgs e)
        {
            ...
            _ = Task.Run(async () =>
            {
                ...
                TeeChartSensor? sensor = _MtpStreamSensorList.FirstOrDefault(x => x.IP.Equals(e.SensorAddress));
        ...
        private void AdxlHook(object? obj, DataEventArgs e)
        {
            ...
            {
                //  Поиск датчика в списке зерегистрованых
                TeeChartSensor? sensor = _AdxlStreamSensorList.FirstOrDefault(x => x.IP.Equals(e.SensorAddress));
        ...
        private void MenuItem_Click_1(object sender, RoutedEventArgs e)
        {
            ...
            TeeChartSensor sensor = new(_FileChart, $"folder {_FileSensorList.Count}", MtpParser.ChannelCount, TeeChartSensor._ChartMaximumCount);
