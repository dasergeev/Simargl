    ...
    ChannelHeader
{
    ...
    /// </summary>
    private CatmanCodeOfFilterCharacteristic _CodeOfFilterCharacteristics;
        ...
        base(StorageFormat.Catman)
    {
        ...
        _CodeOfFilterCharacteristics = CatmanCodeOfFilterCharacteristic.NoFilter;
        ...
        _AmplifierSerialNumber = string.Empty;
        _PhysicalUnit = string.Empty;
        _NativeUnit = string.Empty;
