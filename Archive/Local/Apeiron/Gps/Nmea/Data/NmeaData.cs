...
public sealed class NmeaData
{
    ...
    internal NmeaData(string message)
    {
        ...
        {
            //  Неверная сигнатура строки в формате NMEA.
            throw Exceptions.NmeaInvalidSignature();
        }
        ...
        {
            //  Неверная контрольная сумма строки в формате NMEA.
            throw Exceptions.NmeaInvalidChecksum();
        }
        ...
        //  Установка преамбулы.
        Preamble = new string(new char[] { message[0], message[1] });

        //  Установка мнемоники.
        Mnemonics = new string(new char[] { message[2], message[3], message[4] });
    ...
    private static byte GetCheckSumCore(string text)
    {
        ...
        catch (Exception ex)
        {
            ...
            //  Неверный формат строки в формате NMEA.
            throw Exceptions.NmeaInvalidFormat(ex);
        }
