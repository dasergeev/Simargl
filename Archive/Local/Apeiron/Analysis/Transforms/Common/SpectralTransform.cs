    ...
    Transform
{
    ...
    /// Объект для преобразования.
    /// </param>
    internal protected abstract void InvokeCore([ParameterNoChecks] Spectrum source);
    ...
    /// </param>
    internal protected override sealed void InvokeCore([ParameterNoChecks] Signal source, [ParameterNoChecks] Signal target)
    {
        //  Получение спектра.
