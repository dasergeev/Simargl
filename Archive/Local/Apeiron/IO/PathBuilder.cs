...
public static class PathBuilder
{
    ...
    /// </summary>
    private static readonly char[] _DirectorySeparatorChars = new char[] { '/', '\\' };
    ...
    public static string Combine(params string[] paths)
    {
        ...
        paths = IsNotEmpty(paths, nameof(paths));

        //  Определение количества частей пути.
        int count = paths.Length;

        //  Проверка количества путей.
        if (count == 0)
        {
            //  Передана пустая строка.
            throw Exceptions.ArgumentEmptyString(nameof(paths));
        }
