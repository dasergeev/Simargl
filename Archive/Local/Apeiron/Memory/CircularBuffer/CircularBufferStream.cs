...
public sealed class CircularBufferStream : Stream
{
            ...
            lock (SyncRoot)
            {
                ...
                if (_Position != value)
                {
                    ...
                    if (value < _BeginPosition || value > _EndPosition)
                    {
                        ...
                        throw Exceptions.ArgumentOutOfRange(nameof(value));
                    }
    ...
    public override long Seek(long offset, SeekOrigin origin)
    {
        ...
        lock (SyncRoot)
        {
            ...
            var position = origin switch
            {
                ...
                _ => throw Exceptions.ArgumentNotContainedInEnumeration<SeekOrigin>(nameof(origin)),
            };
    ...
    /// </exception>
    public override void SetLength(long value) => throw Exceptions.OperationNotSupported();
    ...
    void CheckDisposed()
    {
        ...
        {
            //  В результате операции произошло обращение к разрушенному объекту.
            throw Exceptions.OperationObjectDisposed(nameof(CircularBufferStream));
        }
    }
