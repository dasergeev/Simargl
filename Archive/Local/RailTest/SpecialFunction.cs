...
namespace RailTest.Analysis
{
	...
	internal static class SpecialFunction
    {
        ...
        /// В параметре <paramref name="argument"/> передано отрицательное или равное нулю значение.
        /// </exception>
        ...
        public static double Log10(double argument)
		{
			if (argument <= 0.0)
			{
				throw new ArgumentOutOfRangeException("argument", "Передано отрицательное или равное нулю значение.");
			}
			return Math.Log(argument) / 2.30258509299404568401;
		}
        ...
        //	for (int n = 1; n != 100; n++)
        //	{
        //		a *= -(2 * n - 1) * argument / (2 * (2 * n + 1));
        //		result += a;
        //	}
        //	return 1.1283791670955125738961589031215 * result;
        //}
		...
		/// </summary>
		private const double BOLTZMAN = 1.3807e-16;

		/// <summary>
		/// Elementary Charge. Units statcoulomb 
		/// </summary>
		private const double ECHARGE = 4.8032e-10;

		/// <summary>
		/// Electron Mass. Units g 
		/// </summary>
		private const double EMASS = 9.1095e-28;

		/// <summary>
		/// Proton Mass. Units g 
		/// </summary>
		private const double PMASS = 1.6726e-24;

		/// <summary>
		/// Gravitational Constant. Units dyne-cm^2/g^2
		/// </summary>
		private const double GRAV = 6.6720e-08;

		/// <summary>
		/// Planck constant. Units erg-sec 
		/// </summary>
		private const double PLANCK = 6.6262e-27;
		...
		/// </summary>
		private const double STEFANBOLTZ = 5.6703e-5;

		/// <summary>
		/// Avogadro Number. Units  1/mol 
		/// </summary>
		private const double AVOGADRO = 6.0220e23;

		/// <summary>
		/// Gas Constant. Units erg/deg-mol 
		/// </summary>
		private const double GASCONSTANT = 8.3144e07;

		/// <summary>
		/// Gravitational Acceleration at the Earths surface. Units cm/sec^2 
		/// </summary>
		private const double GRAVACC = 980.67;

		/// <summary>
		/// Solar Mass. Units g 
		/// </summary>
		private const double SOLARMASS = 1.99e33;

		/// <summary>
		/// Solar Radius. Units cm
		/// </summary>
		private const double SOLARRADIUS = 6.96e10;

		/// <summary>
		/// Solar Luminosity. Units erg/sec
		/// </summary>
		private const double SOLARLUM = 3.90e33;

		/// <summary>
		/// Solar Flux. Units erg/cm^2-sec
		/// </summary>
		private const double SOLARFLUX = 6.41e10;

		/// <summary>
		/// Astronomical Unit (radius of the Earth's orbit). Units cm
		/// </summary>
		private const double AU = 1.50e13;
        ...
        /// <returns></returns>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
        private static double asinh(double xx)
		{
			double x;
			int sign;
			if (xx == 0.0) return xx;
        ...
        /// <returns></returns>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
        private static double jn(int n, double x)
		{
			int j, m;
        ...
        /// <returns></returns>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
        private static double yn(int n, double x)
		{
        ...
        /// <returns></returns>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
        private static double igamc(double a, double x)
		{
        ...
        /// <returns></returns>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
        private static double igam(double a, double x)
		{
			double ans, ax, c, r;
        ...
        /// <returns></returns>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
        private static double chisq(double df, double x)
		{
        ...
        /// <returns></returns>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
        private static double chisqc(double df, double x)
		{
			if (x < 0.0 || df < 1.0) return 0.0;
        ...
        /// <returns></returns>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
        private static double poisson(int k, double x)
		{
        ...
        /// <returns></returns>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
        private static double poissonc(int k, double x)
		{
			if (k < 0 || x < 0) return 0.0;
        ...
        /// <returns></returns>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
        private static double ibeta(double aa, double bb, double xx)
		{
